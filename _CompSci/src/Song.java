public class Song
{
	...
	public Song(String title, String album, String artist, int songLength) {
	...
	/** modifier method to set the instance variable songLength
		* @param length the name of the album*/
	...
	/** equals method to determine if two songs are equal
		* @param s which is a reference to the song object to be compared
