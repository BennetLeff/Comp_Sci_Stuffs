public class PlayListRunner
{
	public static void main(String[] args)
	{
		...
		PlayListKEY test3 = test2;
		// call the setList() method
		test1.setList(2);
		// test the setList() method
		System.out.println(test1);
		// call the addSong() method
		test2.addSong(0, new SongKEY("song1", "album1", "artist1", 250));
		test2.addSong(1, new SongKEY("song2", "album2", "artist2", 350));
		...
		System.out.println(test2);
		// add song back
		test2.addSong(1, new SongKEY("song1", "album1", "artist1", 250));
